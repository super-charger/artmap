...
import { SystemXiconMGray3Icon } from '@/generated/icons/MyIcons'
...
>(
  (
    { side = 'right', buttonPosition = 'right', className, children, ...props },
    ref,
  ) => (
    <SheetPortal>
      <SheetOverlay />
      ...
      >
        {buttonPosition === 'left' && (
          <SheetCloseButton buttonPosition="left" />
        )}
        {children}
        {buttonPosition === 'right' && (
          <SheetCloseButton buttonPosition="right" />
        )}
      </SheetPrimitive.Content>
    </SheetPortal>
  ),
